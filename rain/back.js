...
})(
  {
    1: [
      function (t, e, i) {
        t("./shim"),
          t("./modules/core.dict"),
          t("./modules/core.get-iterator-method"),
          t("./modules/core.get-iterator"),
          t("./modules/core.is-iterable"),
          t("./modules/core.delay"),
          t("./modules/core.function.part"),
          t("./modules/core.object.is-object"),
          t("./modules/core.object.classof"),
          t("./modules/core.object.define"),
          t("./modules/core.object.make"),
          t("./modules/core.number.iterator"),
          t("./modules/core.string.escape-html"),
          t("./modules/core.string.unescape-html"),
          t("./modules/core.log"),
          (e.exports = t("./modules/$.core"));
      },
      {
        "./modules/$.core": 16,
        ...
        e.exports =
          ...
          function (t, e) {
            var i = r(this),
              ...
              f = 1;
            for (
              l < a && a < l + h && ((f = -1), (l += h - 1), (a += h - 1));
              h-- > 0;

            )
              l in i ? (i[a] = i[l]) : delete i[a], (a += f), (l += f);
            return i;
          };
      },
      { "./$.to-index": 77, "./$.to-length": 80, "./$.to-object": 81 },
    ],
    6: [
      function (t, e, i) {
        "use strict";
        ...
        e.exports = function (t) {
          return function (e, i, o) {
            ...
            if (t && i != i) {
              ...
              for (; u > c; c++) if ((t || c in l) && l[c] === i) return t || c;
            return !t && -1;
          };
        };
      },
      { "./$.to-index": 77, "./$.to-iobject": 79, "./$.to-length": 80 },
    ],
    8: [
      function (t, e, i) {
        var r = t("./$.ctx"),
          ...
          return (
            n(t) &&
              ...
              "function" != typeof i ||
                ...
                (i = void 0),
              r(i) && ((i = i[s]), null === i && (i = void 0))),
            new (void 0 === i ? Array : i)(e)
          );
        };
      },
      { "./$.is-array": 36, "./$.is-object": 38, "./$.wks": 84 },
    ],
    10: [
      function (t, e, i) {
        var r = t("./$.cof"),
                ...
                n(s.prototype, {
                  delete: function (t) {
                    return (
                      !!o(t) &&
                      (f(t)
                        ? c(t, h) && c(t[h], this._i) && delete t[h][this._i]
                        : _(this)["delete"](t))
                    );
                  },
                  has: function (t) {
                    return (
                      !!o(t) &&
                      (f(t) ? c(t, h) && c(t[h], this._i) : _(this).has(t))
                    );
                  },
                }),
                s
      ...
      function (t, e, i) {
        ...
        e.exports = function (t) {
          var e = r.getKeys(t),
            i = r.getSymbols;
          if (i)
            for (var n, s = i(t), o = r.isEnum, a = 0; s.length > a; )
              o.call(t, (n = s[a++])) && e.push(n);
          return e;
        };
      },
      { "./$": 46 },
    ...
    27: [
      function (t, e, i) {
        ...
        e.exports = function (t, e, i, u) {
          ...
          if (s(p))
            for (c = a(t.length); c > m; m++)
              e ? d(o((h = t[m]))[0], h[1]) : d(t[m]);
          else for (f = p.call(t); !(h = f.next()).done; ) n(f, d, h.value, e);
        };
      },
      {
        "./$.an-object": 4,
    ...
    31: [
      ...
      { "./$": 46, "./$.descriptors": 19, "./$.property-desc": 60 },
    ],
    32: [
      function (t, e, i) {
    ...
    41: [
      function (t, e, i) {
        ...
        t("./$.hide")(o, t("./$.wks")("iterator"), function () {
          ...
          (e.exports = function (t, e, i) {
            (t.prototype = r.create(o, { next: n(1, i) })),
              s(t, e + " Iterator");
          });
      },
      {
    ...
    52: [
      function (t, e, i) {
        var r,
          ...
          f = function () {
            var t, e, i;
            for (h && (t = u.domain) && ((u.domain = null), t.exit()); r; )
              (e = r.domain),
                (i = r.fn),
                e && e.enter(),
                i(),
        ...
        if (h)
          ...
          new l(f).observe(d, { characterData: !0 }),
            (s = function () {
              d.data = p = -p;
            });
        } else
        ...
        e.exports = function (t) {
          var e = { fn: t, next: void 0, domain: h && u.domain };
          n && (n.next = e), r || ((r = e), s()), (n = e);
        };
      },
      { "./$.cof": 11, "./$.global": 29, "./$.task": 76 },
    ],
    53: [
      function (t, e, i) {
        var r = t("./$"),
          ...
          ? function (t, e) {
              for (
                ...
                for (
                  var f,
                    p = s(o[l++]),
                    d = c ? u(p).concat(c(p)) : u(p),
                    m = d.length,
                    _ = 0;
                  m > _;

                )
                  h.call(p, (f = d[_++])) && (i[f] = p[f]);
              return i;
            }
          : Object.assign;
      },
      { "./$": 46, "./$.fails": 24, "./$.iobject": 34, "./$.to-object": 81 },
    ],
    54: [
      function (t, e, i) {
        var r = t("./$"),
          ...
          s = t("./$.to-iobject");
        e.exports = function (t, e) {
          for (var i, o = n(s(e)), a = o.length, l = 0; a > l; )
            r.setDesc(t, (i = o[l++]), r.getDesc(e, i));
          return t;
        };
      },
      { "./$": 46, "./$.own-keys": 57, "./$.to-iobject": 79 },
    ],
    55: [
      function (t, e, i) {
        var r = t("./$.export"),
    ...
    56: [
      function (t, e, i) {
        ...
        e.exports = function (t) {
          return function (e) {
            for (
              var i, o = n(e), a = r.getKeys(o), l = a.length, u = 0, c = [];
              l > u;

            )
              s.call(o, (i = a[u++])) && c.push(t ? [i, o[i]] : o[i]);
            return c;
          };
        };
      },
    ...
    58: [
      ...
      { "./$.a-function": 2, "./$.invoke": 33, "./$.path": 59 },
    ],
    59: [
      function (t, e, i) {
        e.exports = t("./$.global");
      ...
      function (t, e, i) {
        ...
        (t("./$.core").inspectSource = function (t) {
          ...
          (e.exports = function (t, e, i, o) {
            "function" == typeof i &&
              (i.hasOwnProperty(s) ||
                n(i, s, t[e] ? "" + t[e] : l.join(String(e))),
              i.hasOwnProperty("name") || n(i, "name", e)),
              t === r ? (t[e] = i) : (o || delete t[e], n(t, e, i));
          })(Function.prototype, o, function () {
            return ("function" == typeof this && this[s]) || a.call(this);
          });
      },
      { "./$.core": 16, "./$.global": 29, "./$.hide": 31, "./$.uid": 83 },
    ],
    63: [
      function (t, e, i) {
        e.exports = function (t, e) {
    ...
    66: [
      ...
      { "./$": 46, "./$.descriptors": 19, "./$.global": 29, "./$.wks": 84 },
    ],
    67: [
      function (t, e, i) {
        var r = t("./$").setDesc,
    ...
    69: [
      ...
      { "./$.a-function": 2, "./$.an-object": 4, "./$.wks": 84 },
    ],
    70: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
    ...
    73: [
      ...
      { "./$.defined": 18, "./$.string-repeat": 74, "./$.to-length": 80 },
    ],
    74: [
      function (t, e, i) {
        "use strict";
    ...
    85: [
      ...
      { "./$.core": 16, "./$.export": 22, "./$.global": 29, "./$.partial": 58 },
    ],
    86: [
      function (t, e, i) {
        "use strict";
        ...
        v(j, "Dict", function () {
          var t,
            ...
            r = e._a,
            n = e._k;
          do if (e._i >= r.length) return (e._t = void 0), y(1);
          while (!w(i, (t = r[e._i++])));
          return "keys" == n
            ? y(0, t)
            : "values" == n
    ...
    87: [
      function (t, e, i) {
        var r = t("./$.path"),
          n = t("./$.export");
        (t("./$.core")._ = r._ = r._ || {}),
          n(n.P + n.F, "Function", { part: t("./$.partial") });
      },
      { "./$.core": 16, "./$.export": 22, "./$.partial": 58, "./$.path": 59 },
    ],
    88: [
      function (t, e, i) {
        var r = t("./$.classof"),
      ...
      { "./$.classof": 10, "./$.core": 16, "./$.iterators": 45, "./$.wks": 84 },
    ],
    89: [
      function (t, e, i) {
        var r = t("./$.an-object"),
      ...
      { "./$.an-object": 4, "./$.core": 16, "./core.get-iterator-method": 88 },
    ],
    90: [
      function (t, e, i) {
        var r = t("./$.classof"),
    ...
    91: [
      function (t, e, i) {
        var r = t("./$"),
          ...
          a = !0;
        r.each.call(
          "assert,clear,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,isIndependentlyComposed,log,markTimeline,profile,profileEnd,table,time,timeEnd,timeline,timelineEnd,timeStamp,trace,warn".split(
            ","
          ),
          function (t) {
            o[t] = function () {
              var e = n.console;
              if (a && e && e[t])
                return Function.apply.call(e[t], e, arguments);
            };
          }
        ),
          s(s.G + s.F, {
      ...
      function (t, e, i) {
        ...
        o ||
          ...
          (n.setDescs = M =
            function (t, e) {
              d(t);
              for (var i, r = n.getKeys(e), s = r.length, o = 0; s > o; )
                n.setDesc(t, (i = r[o++]), e[i]);
              return t;
            })),
          s(s.S + s.F * !o, "Object", {
          ...
          I = function () {
            ...
            for (
              e.style.display = "none",
                ...
                t.open(),
                t.write("<script>document.F=Object</script" + r),
                t.close(),
                I = t.F;
              i--;

            )
              delete I.prototype[D[i]];
            return I();
          },
          N = function (t, e) {
            return function (i) {
        ...
        s(s.P, "Function", {
            ...
            "Array",
            {
              slice: function (t, e) {
                ...
                for (
                  ...
                  a[l] = "String" == r ? this.charAt(n + l) : this[n + l];
                return a;
              },
            }
          ),
          ...
          s(s.S, "Array", { isArray: t("./$.is-array") });
        var B = function (t) {
            return function (e, i) {
              m(e);
              var r = b(this),
        ...
        s(s.P, "Array", {
          ...
          lastIndexOf: function (t, e) {
            var i = v(this),
              ...
              n = r - 1;
            for (
              arguments.length > 1 && (n = Math.min(n, y(e))),
                n < 0 && (n = $(r + n));
              n >= 0;
              n--
            )
    ...
    100: [
      function (t, e, i) {
        var r = t("./$.export");
        r(r.P, "Array", { copyWithin: t("./$.array-copy-within") }),
          ...
          "Array",
          {
            from: function (t) {
              var e,
                ...
                v = u(h);
              if (
                (_ && (m = r(m, d > 2 ? p[2] : void 0, 2)),
                void 0 == v || (f == Array && a(v)))
              )
                for (e = l(h.length), i = new f(e); e > g; g++)
                  i[g] = _ ? m(h[g], g) : h[g];
              else
                for (c = v.call(h), i = new f(); !(n = c.next()).done; g++)
                  i[g] = _ ? o(c, m, [n.value, g], !0) : n.value;
              return (i.length = g), i;
            },
          }
        );
            ...
            of: function () {
              for (
                var t = 0,
                  e = arguments,
                  i = e.length,
                  r = new ("function" == typeof this ? this : Array)(i);
                i > t;
    ...
    119: [
      function (t, e, i) {
        ...
        r(r.S, "Math", {
          hypot: function (t, e) {
            for (
              var i, r, s = 0, o = 0, a = arguments, l = a.length, u = 0;
              o < l;
    ...
    138: [
      function (t, e, i) {
        var r = t("./$.export");
        r(r.S + r.F, "Object", { assign: t("./$.object-assign") });
      },
    ...
    146: [
      function (t, e, i) {
        var r = t("./$.export");
        r(r.S, "Object", { is: t("./$.same-value") });
      },
      { "./$.export": 22, "./$.same-value": 64 },
    ],
    147: [
      function (t, e, i) {
        var r = t("./$.to-object");
    ...
    152: [
      function (t, e, i) {
          ...
          S = (function () {
            ...
            try {
              if (
                ((i = w && w.resolve && P()),
                m(e, w),
                (e.prototype = n.create(w.prototype, {
                  constructor: { value: e },
                })),
                e.resolve(5).then(function () {}) instanceof e || (i = !1),
                i && t("./$.descriptors"))
              ) {
                var r = !1;
                w.resolve(
        ...
        S ||
          ...
          u(u.G + u.W + u.F * !S, { Promise: w }),
          t("./$.set-to-string-tag")(w, x),
          t("./$.set-species")(x),
          (r = t("./$.core")[x]),
          u(u.S + u.F * !S, x, {
            reject: function (t) {
      ...
      function (t, e, i) {
        ...
        t("./$.iter-create")(s, "Object", function () {
          var t,
            e = this,
            i = e._k;
          do if (e._i >= i.length) return { value: void 0, done: !0 };
        ...
        !t("./$.descriptors") ||
          (f &&
            !t("./$.fails")(function () {
              return (
                (h[t("./$.wks")("match")] = !1),
                a(c) != c || a(h) == h || "/a/i" != a(c, "i")
              );
            })) ||
          ((a = function (t, e) {
            var i = s(t),
              r = void 0 === e;
            return this instanceof a || !i || t.constructor !== a || !r
              ? f
                ? new l(i && !r ? t.source : t, e)
                : l((i = t instanceof a) ? t.source : t, i && r ? o.call(t) : e)
              : t;
          }),
          ...
          (u.constructor = a),
          (a.prototype = u),
          t("./$.redefine")(n, "RegExp", a)),
          t("./$.set-species")("RegExp");
      },
      {
        "./$": 46,
        "./$.descriptors": 19,
        ...
        r(r.S + r.F * (!!o && 1 != o.length), "String", {
          fromCodePoint: function (t) {
            for (var e, i = [], r = arguments, o = r.length, a = 0; o > a; ) {
              if (((e = +r[a++]), n(e, 1114111) !== e))
                throw RangeError(e + " is not a valid code point");
              i.push(
                e < 65536
                  ? s(e)
                  : s(((e -= 65536) >> 10) + 55296, (e % 1024) + 56320)
              );
            }
            return i.join("");
          },
    ...
    177: [
      ...
      { "./$.export": 22, "./$.fails-is-regexp": 23, "./$.string-context": 72 },
    ],
    178: [
      function (t, e, i) {
        "use strict";
        ...
        t("./$.iter-define")(
          ...
          function () {
            ...
            return i >= e.length
              ? { value: void 0, done: !0 }
              : ((t = r(e, i)), (this._i += t.length), { value: t, done: !1 });
          }
        );
      },
      { "./$.iter-define": 42, "./$.string-at": 71 },
    ],
    179: [
      function (t, e, i) {
        var r = t("./$.export"),
        ...
        r(r.S, "String", {
          raw: function (t) {
            for (
              ...
              a.push(String(e[l++])), l < o && a.push(String(r[l]));
            return a.join("");
          },
        });
      },
      { "./$.export": 22, "./$.to-iobject": 79, "./$.to-length": 80 },
    ],
    180: [
      function (t, e, i) {
        var r = t("./$.export");
    ...
    183: [
      function (t, e, i) {
        ...
        var r = t("./$"),
            ...
            return (
              ...
              o &&
                ...
                F(D, t, {
                  configurable: !0,
                  set: function (e) {
                    s(this, k) && s(this[k], t) && (this[k][t] = !1),
                      F(this, t, x(1, e));
                  },
                }),
              e
          ...
          N = function (t, e, i) {
            return i && s(M, e)
              ? (i.enumerable
                  ? (s(t, k) && t[k][e] && (t[k][e] = !1),
                    (i = w(i, { enumerable: x(0, !1) })))
                  : (s(t, k) || b(t, k, x(1, {})), (t[k][e] = !0)),
                F(t, e, i))
              : b(t, e, i);
          },
          z = function (t, e) {
            v(t);
            for (var i, r = _((e = y(e))), n = 0, s = r.length; s > n; )
              N(t, (i = r[n++]), e[i]);
            return t;
          },
          L = function (t, e) {
          ...
          B = function (t) {
            var e = R.call(this, t);
            return (
              !(e || !s(this, t) || !s(M, t) || (s(this, k) && this[k][t])) || e
            );
          },
          X = function (t, e) {
            var i = $((t = y(t)), e);
            return (
              !i || !s(M, e) || (s(t, k) && t[k][e]) || (i.enumerable = !0), i
            );
          },
          U = function (t) {
            for (var e, i = T(y(t)), r = [], n = 0; i.length > n; )
              s(M, (e = i[n++])) || e == k || r.push(e);
            return r;
          },
          Y = function (t) {
            for (var e, i = T(y(t)), r = [], n = 0; i.length > n; )
              s(M, (e = i[n++])) && r.push(M[e]);
            return r;
          },
          G = function (t) {
            if (void 0 !== t && !I(t)) {
        ...
        C ||
          ...
          (r.getNames = m.get = U),
          (r.getSymbols = Y),
          o && !t("./$.library") && l(D, "propertyIsEnumerable", B, !0));
        var W = {
          for: function (t) {
        ...
        r.each.call(
          ...
          S && a(a.S + a.F * (!C || q), "JSON", { stringify: G }),
          h(P, "Symbol"),
          h(Math, "Math", !0),
          h(n.JSON, "JSON", !0);
      },
    ...
    184: [
      function (t, e, i) {
        ...
        7 != new f().set((Object.freeze || Object)(h), 7).get(h) &&
        ...
        n(n.S, "Object", {
          getOwnPropertyDescriptors: function (t) {
            for (
              ...
              (i = u(n, (e = c[f++]))), e in h ? l(h, e, a(0, i)) : (h[e] = i);
            return h;
          },
        });
      },
    ...
    202: [
      function (t, e, i) {
        t("./modules/es5"),
          ...
          t("./modules/es7.string.pad-left"),
          t("./modules/es7.string.pad-right"),
          t("./modules/es7.string.trim-left"),
          t("./modules/es7.string.trim-right"),
          t("./modules/es7.regexp.escape"),
              ...
              function (t, e, i) {
                ...
                (s.version = "1.19.1"),
                  ...
                  (c.updateTo = function (t, e) {
                    ...
                    if (this._initted || s)
                      if (e) (this._initted = !1), s && this.render(0, !0, !0);
                        ...
                        for (var a, l = 1 / (1 - n), u = this._firstPT; u; )
                          (a = u.s + u.c),
                            (u.c *= l),
                            (u.s = a - u.c),
                            (u = u._next);
                      ...
                      var d,
                        ...
                        x = function () {
                          o.onComplete &&
                            ...
                            c.apply(p || o.callbackScope || this, f || h);
                        },
                        $ = o.cycle,
                  ...
                  (s.staggerFromTo = s.allFromTo =
                    function (t, e, i, r, n, o, a, l) {
                      return (
                        (r.startAt = i),
                        (r.immediateRender =
                          0 != r.immediateRender && 0 != i.immediateRender),
                        s.staggerTo(t, e, r, n, o, a, l)
                      );
                    }),
                ...
                (s.killAll = function (t, i, r, n) {
                  ...
                  for (a = 0; a < u; a++)
                    (o = l[a]),
                      (c ||
                        o instanceof e ||
                        ((s = o.target === o.vars.onComplete) && r) ||
                        (i && !s)) &&
                        (t
                      ...
                      if (
                        ...
                        for (c in p)
                          for (o = p[c].target.parentNode; o; )
                            o === t && (n = n.concat(p[c].tweens)),
                              (o = o.parentNode);
                        for (f = n.length, h = 0; h < f; h++)
                ...
                var d = function (t, i, r, n) {
                  (i = i !== !1), (r = r !== !1), (n = n !== !1);
                  for (
                    var s, o, a = p(n), l = i && r && n, u = a.length;
                    --u > -1;
              ...
              i._gsDefine(
                ...
                function (t, e, r) {
                  ...
                  return (
                    ...
                    (g.to = function (t, e, i, n) {
                      var s = (i.repeat && f.TweenMax) || r;
                      return e
                        ? this.add(new s(t, e, i), n)
                        : this.set(t, i, n);
                    }),
                    (g.from = function (t, e, i, n) {
                      return this.add(
                        ((i.repeat && f.TweenMax) || r).from(t, e, i),
                        n
                      );
                    }),
                    ...
                    (g.staggerTo = function (t, e, i, s, o, a, u, c) {
                      var h,
                        ...
                        g = i.cycle;
                      for (
                        "string" == typeof t && (t = r.selector(t) || t),
                          t = t || [],
                          l(t) && (t = _(t)),
                          s = s || 0,
                        ...
                        (h = p(i)),
                          h.startAt &&
                            ((h.startAt = p(h.startAt)),
                            h.startAt.cycle && d(h.startAt, t, f)),
                          g &&
                            (d(h, t, f),
                            null != h.duration &&
                    ...
                    (g.staggerFromTo = function (t, e, i, r, n, s, o, a, l) {
                      return (
                        ...
                        (r.immediateRender =
                          0 != r.immediateRender && 0 != i.immediateRender),
                        this.staggerTo(t, e, r, n, s, o, a, l)
                      );
                    }),
                    ...
                    (g._parseTimeOrLabel = function (e, i, r, n) {
                      ...
                      if (
                        ...
                        (i =
                          ...
                          (e =
                            s > 1
                              ? this._parseTimeOrLabel(e.substr(0, s - 1), 0, r)
                              : this.duration());
                      }
                      return Number(e) + i;
                    }),
                    ...
                    (g.render = function (t, e, i) {
                      ...
                      if ((this._time !== d && this._first) || i || l || u) {
                        ...
                        this._onUpdate &&
                          (e || (c.length && h(), this._callback("onUpdate"))),
                          a &&
                            (this._gc ||
                              (m !== this._startTime &&
                                _ === this._timeScale) ||
                    ...
                    (g.totalDuration = function (t) {
                      if (!arguments.length) {
                        if (this._dirty) {
                          for (
                            var e, i, r = 0, n = this._last, s = 999999999999;
                            n;
                ...
                function (t, e, r) {
                  ...
                  return (
                    ...
                    (h.tweenFromTo = function (t, e, i) {
                      ...
                      return r.duration(
                        Math.abs(r.vars.time - t) / this._timeScale || 0.001
                      );
                    }),
                    (h.render = function (t, e, i) {
                      ...
                      if (t >= d - 1e-7 && t >= 0)
                        ...
                        if (
                          ...
                          (0 !== _ ||
                            (0 === m &&
                              ...
                              (x > 0 || (t < 0 && x >= 0)) &&
                              !this._locked)) &&
                            ((u = "onReverseComplete"), (n = this._reversed)),
                          t < 0)
                        )
                          (this._active = !1),
                            this._timeline.autoRemoveChildren && this._reversed
                              ? ((c = n = !0), (u = "onReverseComplete"))
                              : x >= 0 && this._first && (c = !0),
                            (this._rawPrevTime = t);
                        else {
                          if (
                        ...
                        if (
                          ((t = this._time),
                          t >= _ || (this._repeat && b !== this._cycle))
                        )
              ...
              (function () {
                var t = 180 / Math.PI,
                  ...
                  f = function (t, i, o, a, u, f) {
                    ...
                    if (t.length > 1) {
                      for (
                        x = t[t.length - 1], y = !0, p = b.length;
                        --p > -1;

                      )
                        if (((d = b[p]), Math.abs(w[d] - x[d]) > 0.05)) {
                          y = !1;
                          break;
                        }
                      y &&
                    ...
                    for (
                      e.length = r.length = n.length = 0, p = b.length;
                      --p > -1;
                      ...
                      (d = b[p]),
                        ...
                        ($[d] = h(t, d, s[d], f));
                    for (p = e.length; --p > -1; )
                      (e[p] = Math.sqrt(e[p])), (r[p] = Math.sqrt(r[p]));
                    if (!a) {
                      for (p = b.length; --p > -1; )
                        if (s[d])
                          for (m = $[b[p]], v = m.length - 1, _ = 0; _ < v; _++)
                            (g = m[_ + 1].da / r[_] + m[_].da / e[_] || 0),
                              (n[_] = (n[_] || 0) + g * g);
                      for (p = n.length; --p > -1; ) n[p] = Math.sqrt(n[p]);
                    }
                    for (p = b.length, _ = o ? 4 : 1; --p > -1; )
                      (d = b[p]),
                        (m = $[d]),
                        c(m, i, o, a, s[d]),
                  ...
                  p = function (t, e, i) {
                    ...
                    for (u = v.length; --u > -1; ) {
                      for (
                        f = v[u], m[f] = l = [], p = 0, h = t.length, c = 0;
                        c < h;
                        c++
                      )
                        (r =
                  ...
                  _ = i._gsDefine.plugin({
                    ...
                    set: function (e) {
                      ...
                      if (this._timeRes) {
                        ...
                        a =
                          (n + (e - this._s1) / (this._s2 - this._s1)) *
                            this._prec || 0;
                      } else
                ...
                (_.bezierThrough = f),
                  ...
                  (g._mod = function (t) {
                    for (
                      var e, i = this._overwriteProps, r = i.length;
                      --r > -1;

                    )
                      (e = t[i[r]]),
                        e && "function" == typeof e && (this._mod[i[r]] = e);
                  }),
                  (g._kill = function (t) {
                    var e,
                      i,
              ...
              i._gsDefine(
                ...
                function (t, e) {
                  ...
                  var h,
                    ...
                    W = (function () {
                      ...
                      return (
                        ...
                        (m =
                          p &&
                          parseFloat(q.substr(q.indexOf("Version/") + 8, 2)) <
                            6),
                    ...
                    et = (G.convertToPixels = function (t, i, r, n, s) {
                      ...
                      if (
                        (p && (r = -r),
                        d && (r *= 100),
                        "%" === n && i.indexOf("border") !== -1)
                      )
                        o = (r / 100) * (c ? t.clientWidth : t.clientHeight);
                      else {
                        if (
                          ((f.cssText =
                        ...
                        h.appendChild(U),
                          ...
                          c &&
                            "%" === n &&
                            a.cacheWidths !== !1 &&
                            ((l = h._gsCache = h._gsCache || {}),
                            (l.time = u),
                            (l.width = (o / r) * 100)),
                          0 !== o || s || (o = et(t, i, r, n, !0));
                      }
                    ...
                    it = (G.calculateOffset = function (t, e, i) {
                      ...
                      return (
                        t["offset" + r] -
                        (et(t, e, parseFloat(n), n.replace(w, "")) || 0)
                      );
                    }),
                    rt = function (t, e) {
                      var i,
                      ...
                      if ((e = e || J(t, null)))
                        if ((i = e.length))
                          for (; --i > -1; )
                            (n = e[i]),
                              (n.indexOf("-transform") !== -1 && Rt !== n) ||
                                (s[n.replace(k, A)] = e.getPropertyValue(n));
                        else
                          for (i in e)
                            (i.indexOf("Transform") !== -1 && kt !== i) ||
                              (s[i] = e[i]);
                  ...
                  var gt = function (t, e, i, r) {
                    ...
                    xt =
                      ((G._parseToProxy = function (t, e, i, r, n, s) {
                        var o,
                          a,
                          l,
                          u,
                          ...
                          if (
                            ...
                            for (o = r.l; --o > 0; )
                              (l = "xn" + o),
                                ...
                                (p[a] = r.data[l]),
                                (f[a] = r[l]),
                                s || (u = new yt(r, l, a, u, r.rxp[l]));
                          r = r._next;
                        }
                        return { proxy: f, end: p, firstMPT: u, pt: c };
                      }),
                      (G.CSSPropTween = function (
                        t,
                        e,
                        i,
                        n,
                    ...
                    bt = (a.parseComplex = function (
                      ...
                      var f,
                        ...
                        M = h !== !1;
                      for (
                        (r.indexOf(",") === -1 && i.indexOf(",") === -1) ||
                          ((k = k.join(" ").replace(F, ", ").split(" ")),
                          (R = R.join(" ").replace(F, ", ").split(" ")),
                          (A = k.length)),
                          A !== R.length &&
                            ((k = (s || "").split(" ")), (A = k.length)),
                          o.plugin = u,
                          o.setRatio = c,
                          _t.lastIndex = 0,
                          f = 0;
                        ...
                        if (
                          ...
                          (O = _.indexOf(")") + 1),
                            ...
                            (m = dt(m, j)),
                            (_ = dt(_, j)),
                            (T = m.length + _.length > 6),
                            T && !W && 0 === _[3]
                              ? ((o["xs" + o.l] += o.l
                                  ? " transparent"
                                  : "transparent"),
                                (o.e = o.e.split(R[f]).join("transparent")))
                              : (W || (T = !1),
                                j
                                  ? o
                                      .appendXtra(
                          ...
                          if (((b = _.match(x)), !b || b.length !== $.length))
                            return o;
                          for (d = 0, p = 0; p < $.length; p++)
                            (S = $[p]),
                              (P = m.indexOf(S, d)),
                              o.appendXtra(
                                m.substr(d, P - d),
                    ...
                    wt = 9;
                  for (c = xt.prototype, c.l = c.pr = 0; --wt > 0; )
                    (c["xn" + wt] = 0), (c["xs" + wt] = "");
                  (c.xs0 = ""),
                    (c._next =
                      c._prev =
                  ...
                  var Ot,
                    ...
                    Nt = function (t, e, i, r, n, s) {
                      ...
                      $ && ((y = $.xOrigin), (x = $.yOrigin)),
                        ...
                        r &&
                          ...
                          v &&
                            ((l =
                              c * (m / v) + h * (-d / v) + (d * g - m * _) / v),
                            (u =
                              c * (-p / v) + h * (f / v) - (f * g - p * _) / v),
                            (c = i.xOrigin = o[0] = l),
                            (h = i.yOrigin = o[1] = u))),
                        $ &&
                          (s &&
                          ...
                          n || (n !== !1 && a.defaultSmoothOrigin !== !1)
                            ? ((l = c - y),
                              (u = h - x),
                              ($.xOffset += l * b[0] + u * b[2] - l),
                              ($.yOffset += l * b[1] + u * b[3] - u))
                            : ($.xOffset = $.yOffset = 0)),
                    ...
                    Yt = (G.getTransform = function (t, i, r, n) {
                      ...
                      var s,
                        ...
                        c,
                        h,
                        f = r ? t._gsTransform || new Ct() : new Ct(),
                        p = f.scaleX < 0,
                        d = 2e-5,
                        m = 1e5,
                        _ = Mt
                          ? parseFloat(
                              tt(t, At, i, !1, "0 0 0").split(" ")[2]
                            ) ||
                            f.zOrigin ||
                            0
                          : 0,
                      ...
                      if (
                        ...
                        if (16 === s.length) {
                          ...
                          f.zOrigin &&
                            ...
                            (f.scaleX =
                              ((Math.sqrt(w * w + T * T) * m + 0.5) | 0) / m),
                            (f.scaleY =
                              ((Math.sqrt(j * j + M * M) * m + 0.5) | 0) / m),
                            (f.scaleZ =
                            ...
                            f.svg &&
                              ((f.x -=
                                f.xOrigin - (f.xOrigin * w - f.yOrigin * O)),
                              (f.y -=
                                f.yOrigin - (f.yOrigin * T - f.xOrigin * j)));
                        } else if (
                          !Mt ||
                          n ||
                          !s.length ||
                          ...
                          (f.x = s[4] || 0),
                            ...
                            (u = Math.sqrt(Y * Y + U * U)),
                            (c =
                              B || X ? Math.atan2(X, B) * N : f.rotation || 0),
                            (h =
                              U || Y ? Math.atan2(U, Y) * N + c : f.skewX || 0),
                            Math.abs(h) > 90 &&
                              Math.abs(h) < 270 &&
                              (p
                                ? ((l *= -1),
                            ...
                            f.svg &&
                              ((f.x -=
                                f.xOrigin - (f.xOrigin * B + f.yOrigin * U)),
                              (f.y -=
                                f.yOrigin - (f.xOrigin * X + f.yOrigin * Y)));
                        }
                        f.zOrigin = _;
                    ...
                    Gt = function (t) {
                      ...
                      if (f) {
                        ...
                        if (
                          (null != r.ox &&
                            ((p = (r.oxp ? m * r.ox * 0.01 : r.ox) - m / 2),
                            (d = (r.oyp ? g * r.oy * 0.01 : r.oy) - g / 2),
                            (x += p - (p * a + d * l)),
                            ($ += d - (p * u + d * c))),
                          v
                            ? ((p = m / 2),
                              ...
                              ? ((O *= I),
                                ...
                                E &&
                                  ...
                                  Ot &&
                                    ...
                                    ((_ = this.t.getBBox()),
                                    (C += 0.01 * P.xPercent * _.width),
                                    (D += 0.01 * P.yPercent * _.height)),
                                  (_ = 1e-6),
                                  C < _ && C > -_ && (C = 0),
                                  D < _ && D > -_ && (D = 0)),
                                (x =
                      ...
                      "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                      {
                        parser: function (t, e, i, r, n, o, l) {
                          ...
                          if (
                            ...
                            (f = U.style),
                              ...
                              k.svg &&
                                ...
                                (S.transformOrigin || S.svgOrigin) &&
                                  ...
                                  (_ = R.xOrigin),
                                  (y = R.yOrigin),
                                  (h.x -= R.xOffset - k.xOffset),
                                  (h.y -= R.yOffset - k.yOffset)),
                                (_ || y) &&
                                  ((x = Ut(U, !0)),
                                  (h.x -= _ - (_ * x[0] + y * x[2])),
                                  (h.y -= y - (_ * x[1] + y * x[3])))),
                              ...
                              null != S.xPercent &&
                                (h.xPercent = ct(S.xPercent, k.xPercent)),
                              null != S.yPercent &&
                                (h.yPercent = ct(S.yPercent, k.yPercent));
                            ...
                            "string" == typeof S.x &&
                              S.x.indexOf("%") !== -1 &&
                              ((h.x = 0), (h.xPercent = ct(S.x, k.xPercent))),
                              "string" == typeof S.y &&
                                S.y.indexOf("%") !== -1 &&
                                ((h.y = 0), (h.yPercent = ct(S.y, k.yPercent))),
                              (h.rotation = ht(
                                "rotation" in S
                                  ? S.rotation
                                  : "shortRotation" in S
                              ...
                              (h.skewX = ht(S.skewX, k.skewX)),
                              (h.skewY = ht(S.skewY, k.skewY));
                          }
                          for (
                            Mt &&
                              null != S.force3D &&
                              ((k.force3D = S.force3D), (d = !0)),
                              k.skewType =
                                S.skewType || k.skewType || a.defaultSkewType,
                              p =
                                k.force3D ||
                                k.z ||
                                k.rotationX ||
                          ...
                          return (
                            ...
                            k.svg &&
                              ...
                              ((_ = k.xOffset),
                              (y = k.yOffset),
                              Nt(t, lt(R), h, S.svgOrigin, S.smoothOrigin),
                              (n = $t(
                                k,
                                "xOrigin",
                                (b ? k : h).xOrigin,
                    ...
                    Pt("borderRadius", {
                      ...
                      parser: function (t, e, i, r, o, a) {
                        ...
                        for (
                          ...
                          this.p.indexOf("border") && (T[u] = Q(T[u])),
                            (f = h = tt(t, T[u], s, !1, "0px")),
                            f.indexOf(" ") !== -1 &&
                  ...
                  var Wt = function (t) {
                    ...
                    100 === n &&
                      ...
                      r.indexOf("oader(") === -1
                        ...
                        : ((i.filter = r.replace(S, "")), (e = !0))),
                      e ||
                        (this.xn1 &&
                          (i.filter = r = r || "alpha(opacity=" + n + ")"),
                        r.indexOf("pacity") === -1
                          ? (0 === n && this.xn1) ||
                      ...
                      e &&
                        (t.removeProperty
                          ? (("ms" !== e.substr(0, 2) &&
                              "webkit" !== e.substr(0, 6)) ||
                              (e = "-" + e),
                            t.removeProperty(e.replace(j, "-$1").toLowerCase()))
                          : t.removeAttribute(e));
                    },
                    Zt = function (t) {
                  ...
                  Pt("className", {
                    parser: function (t, e, i, n, o, a, l) {
                      var u,
                        ...
                        m = t.style.cssText;
                      if (
                        ((o = n._classNamePT = new xt(t, i, 0, 0, o, 2)),
                        (o.setRatio = Zt),
                        (o.pr = -11),
                        (r = !0),
                        (o.b = d),
                  ...
                  (c = a.prototype),
                    ...
                    (c._onInitTween = function (t, e, i, l) {
                      ...
                      if (r) {
                        for (; d; ) {
                          for ($ = d._next, _ = y; _ && _.pr > d.pr; )
                            _ = _._next;
                          (d._prev = _ ? _._prev : x)
                            ? (d._prev._next = d)
                            : (y = d),
                            (d._next = _) ? (_._prev = d) : (x = d),
                            (d = $);
                        }
                        this._firstPT = y;
                      }
                    ...
                    (c._enableTransforms = function (t) {
                      (this._transform =
                        this._transform || Yt(this._target, s, !0)),
                        (this._transformType =
                    ...
                    (c._kill = function (e) {
                      ...
                      for (
                        e.className &&
                          ...
                          i._next &&
                            this._linkCSSP(i._next, i._next._next, n._prev),
            ...
            (function (t, i) {
              ...
              if (!s.TweenLite) {
                var o,
                  ...
                  v = function (n, o, a, l) {
                    ...
                    (this.check = function (c) {
                      for (var f, p, d, m, _, y = o.length, x = y; --y > -1; )
                        (f = g[o[y]] || new v(o[y], [])).gsClass
                          ? ((u[y] = f.gsClass), x--)
                          : c && f.sc.push(this);
                      if (0 === x && a) {
                        if (
                          ((p = ("com.greensock." + n).split(".")),
                          (d = p.pop()),
                          (m =
                            h(p.join("."))[d] =
                            this.gsClass =
                          ...
                          if (
                            ((s[d] = r[d] = m),
                            (_ = "undefined" != typeof e && e.exports),
                ...
                for (
                  ...
                  (l = o[a] + ",Power" + a),
                    T(new b(null, null, 1, a), l, "easeOut", !0),
                    T(
                      new b(null, null, 2, a),
                      l,
                      "easeIn" + (0 === a ? ",easeNone" : "")
                    ),
                    T(new b(null, null, 3, a), l, "easeInOut");
                ...
                (l = P.prototype),
                  (l.addEventListener = function (t, e, i, r, n) {
                    n = n || 0;
                    var s,
                      o,
                      a = this._listeners[t],
                    ...
                    for (
                      ...
                      (s = a[o]),
                        s.c === e && s.s === i
                          ? a.splice(o, 1)
                          : 0 === l && s.pr < n && (l = o + 1);
                    a.splice(l, 0, { c: e, s: i, up: r, pr: n });
                  }),
                ...
                var C = x(
                    ...
                    function (e, i, r) {
                      ...
                      this.target = e =
                        "string" != typeof e ? e : C.selector(e) || e;
                      var n,
                        s,
                        o,
                        a =
                            ...
                            s
                              ? "string" != typeof s
                                ? s.length &&
                                  ...
                                  : ((this._siblings[n] = Q(s, this, !1)),
                                    1 === l &&
                                      this._siblings[n].length > 1 &&
                                      tt(s, this, null, 1, this._siblings[n]))
                                : ((s = o[n--] = C.selector(s)),
                                  "string" == typeof s && o.splice(n + 1, 1))
                              : o.splice(n--, 1);
                      else
                        (this._propLookup = {}),
                ...
                (l = C.prototype = new R()),
                  ...
                  (C.version = "1.19.1"),
                  (C.defaultEase = l._ease = new b(null, null, 1, 1)),
                ...
                var E = [],
                  ...
                  L = function (t, e, i, r) {
                    ...
                    for (
                      ...
                      (c = s[a]),
                        ...
                        (f += c.length);
                    return (
                      (p += e.substr(f)), p && h.push(p), (h.setRatio = z), h
                    );
                  },
                  B = function (t, e, i, r, n, s, o, a, l) {
                    ...
                    if (
                      (("number" != typeof f || ("number" != typeof r && !p)) &&
                        (o ||
                        isNaN(f) ||
                        (!p && isNaN(r)) ||
                        "boolean" == typeof f ||
                ...
                (Z._startTime = u.time),
                  ...
                  setTimeout(H, 1),
                  (R._updateRoot = C.render =
                    function () {
                      var t, e, i;
                      if (
                        (E.length && H(),
                        Z.render(
                          (u.time - Z._startTime) * Z._timeScale,
                          !1,
                          !1
                        ),
                        V.render(
                          (u.frame - V._startTime) * V._timeScale,
                          !1,
                          !1
                        ),
                        E.length && H(),
                  ...
                  et = function (t, e, i) {
                    ...
                    return (
                      ...
                      s > e
                        ...
                        ? p
                        : (s += t.totalDuration() / t._timeScale / n) > e + p
                        ? 0
                        : s - e - p
                    );
                  };
                (l._init = function () {
                  ...
                  if (
                    (e && C._onPluginEvent("_onInitAllProps", this),
                    a &&
                      (this._firstPT ||
                    ...
                    I[e._gsTweenID] && H(),
                      this.vars.css ||
                        (e.style &&
                          ...
                          F(this.vars, e));
                    for (o in this.vars)
                      if (((h = this.vars[o]), q[o]))
                        h &&
                          (h instanceof Array || (h.push && _(h))) &&
                          h.join("").indexOf("{self}") !== -1 &&
                          (this.vars[o] = h = this._swapSelfInParams(h, this));
                      else if (
                        U[o] &&
                        (u = new U[o]())._onInitTween(e, this.vars[o], this, s)
                      ) {
                        for (
                          this._firstPT = c =
                            {
                  ...
                  (l._enabled = function (t, e) {
                    ...
                    return (
                      ...
                      !(!this._notifyPluginsOfEnabled || !this._firstPT) &&
                        C._onPluginEvent(t ? "_onEnable" : "_onDisable", this)
                    );
                  }),
                  (C.to = function (t, e, i) {
                    return new C(t, e, i);
                  ...
                  (C.getTweensOf = function (t, e) {
                    ...
                    if ((_(t) || D(t)) && "number" != typeof t[0]) {
                      ...
                      for (r = Q(t).concat(), i = r.length; --i > -1; )
                        (r[i]._gc || (e && !r[i].isActive())) && r.splice(i, 1);
                    return r;
                  }),
                  (C.killTweensOf = C.killDelayedCallsTo =
                    function (t, e, i) {
                      "object" == typeof e && ((i = e), (e = !1));
                      for (
                        var r = C.getTweensOf(t, e), n = r.length;
                        --n > -1;
        ...
        (n.prototype = {
          ...
          init: function (t, e, i, r) {
            (this.canvas = t),
              ...
              (this.gl = o.getContext(t, e)),
              (this.program = this.createProgram(i, r)),
          ...
          createUniform: function (t, e) {
            for (
              var i = arguments.length, r = Array(i > 2 ? i - 2 : 0), n = 2;
              n < i;
              n++
            )
              r[n - 2] = arguments[n];
          ...
          draw: function () {
            o.setRectangle(this.gl, -1, -1, 2, 2),
      ...
      function (t, e, i) {
        ...
        function n() {
          (0, y["default"])([
            ...
            { name: "textureRainFg", src: "img/weather/texture-rain-bg.png" },
            ...
            { name: "textureSunFg", src: "img/weather/texture-rain-bg.png" },
            { name: "textureSunBg", src: "img/weather/texture-rain-bg.png" },
            {
            ...
            (O = t.textureRainFg.img),
              ...
              (A = t.textureFalloutFg.img),
              (M = t.textureFalloutBg.img),
              (k = t.textureStormLightningFg.img),
              (R = t.textureStormLightningBg.img),
              (C = t.textureSunFg.img),
              (D = t.textureSunBg.img),
              (F = t.textureDrizzleFg.img),
              (E = t.textureDrizzleBg.img),
              (I = t.dropColor.img),
              (N = t.dropAlpha.img),
              s();
          });
        ...
        function h() {
          ...
          "" != t && (e = document.querySelector(t)),
            null == e &&
              ...
              (t = "#" + e.getAttribute("id"))),
            (i = document.querySelector("[href='" + t + "']"));
          ...
          null != s && s.classList.remove("nav-item--current"),
            e.classList.add("slide--current"),
            i.classList.add("nav-item--current");
        }
        function f(t, e, i, r) {
          function n(n) {
            var o =
        ...
        function p(t, e) {
          ...
          (L.globalAlpha = i),
            L.drawImage(t, 0, 0, Y.width, Y.height),
            (X.globalAlpha = i),
            X.drawImage(e, 0, 0, U.width, U.height);
        }
        t("core-js");
        ...
        (s.prototype = Object.defineProperties(
          {
            ...
            init: function () {
              (this.width = this.canvas.width),
                ...
                (this.gl = new l["default"](this.canvas, { alpha: !1 }, f, p));
              var t = this.gl;
              (this.programWater = t.program),
                t.createUniform("2f", "resolution", this.width, this.height),
                t.createUniform(
                  "1f",
                  "textureRatio",
                  this.imageBg.width / this.imageBg.height
                ),
                t.createUniform("1i", "renderShine", null != this.imageShine),
                t.createUniform(
                  "1i",
                  "renderShadow",
                  this.options.renderShadow
                ),
                t.createUniform(
                  "1f",
                  "minRefraction",
                ...
                t.createUniform("1f", "brightness", this.options.brightness),
                t.createUniform(
                  "1f",
                  "alphaMultiply",
                ...
                t.createUniform("1f", "parallaxBg", this.options.parallaxBg),
                t.createUniform("1f", "parallaxFg", this.options.parallaxFg),
                t.createTexture(null, 0),
                (this.textures = [
                  {
                    name: "textureShine",
                    img:
                      null == this.imageShine
                        ? (0, h["default"])(2, 2)
                        : this.imageShine,
                  },
                ...
                this.textures.forEach(function (e, i) {
                  t.createTexture(e.img, i + 1),
                    t.createUniform("1i", e.name, i + 1);
                }),
                this.draw();
            },
            draw: function () {
        ...
        (s.prototype = Object.defineProperties(
          {
            ...
            options: null,
            init: function () {
              (this.canvas = (0, c["default"])(this.width, this.height)),
                (this.ctx = this.canvas.getContext("2d")),
                (this.droplets = (0, c["default"])(
            ...
            renderDropsGfx: function () {
              var t = this,
                e = (0, c["default"])(f, f),
                i = e.getContext("2d");
              (this.dropsGfx = Array.apply(null, Array(255)).map(function (
                r,
                n
              ) {
                ...
                return (
                  ...
                  i.drawImage(t.dropColor, 0, 0, f, f),
                  (i.globalCompositeOperation = "screen"),
                  (i.fillStyle = "rgba(0,0," + n + ",1)"),
                  i.fillRect(0, 0, f, f),
                  (o.globalCompositeOperation = "source-over"),
                  o.drawImage(t.dropAlpha, 0, 0, f, f),
                  (o.globalCompositeOperation = "source-in"),
                  o.drawImage(e, 0, 0, f, f),
                  s
                );
              })),
            ...
            drawDrop: function (t, e) {
              if (this.dropsGfx.length > 0) {
                var i = e.x,
                  ...
                  u = Math.max(
                    0,
                    Math.min(1, ((n - this.options.minR) / this.deltaR) * 0.9)
                  );
                (u *= 1 / (0.5 * (e.spreadX + e.spreadY) + 1)),
                  (t.globalAlpha = 1),
                  (t.globalCompositeOperation = "source-over"),
                  (u = Math.floor(u * (this.dropsGfx.length - 1))),
                  t.drawImage(
                    this.dropsGfx[u],
                    (i - n * a * (s + 1)) * this.scale,
                    (r - n * l * (o + 1)) * this.scale,
                    2 * n * a * (s + 1) * this.scale,
                    2 * n * l * (o + 1) * this.scale
                  );
              }
            },
            clearDroplets: function (t, e) {
              ...
              (r.globalCompositeOperation = "destination-out"),
                r.drawImage(
                  ...
                  (t - i) * this.dropletsPixelDensity * this.scale,
                  (e - i) * this.dropletsPixelDensity * this.scale,
                  2 * i * this.dropletsPixelDensity * this.scale,
            ...
            createDrop: function (t) {
              return this.drops.length >=
                ...
                ? null
                : Object.assign(Object.create(p), t);
            },
            addDrop: function (t) {
              return (
                !(
                  this.drops.length >=
                    this.options.maxDrops * this.areaMultiplier || null == t
                ) && (this.drops.push(t), !0)
              );
            },
            updateRain: function (t) {
              ...
              if (this.options.raining)
                for (
                  var i = this.options.rainLimit * t * this.areaMultiplier,
                    r = 0;
                  (0, h.chance)(
                    this.options.rainChance * t * this.areaMultiplier
                  ) && r < i;
                  ...
                  var n = (0, h.random)(
                    ...
                    s = this.createDrop({
                      ...
                      r: n,
                      momentum:
                        1 + 0.1 * (n - this.options.minR) + (0, h.random)(2),
                      spreadX: 1.5,
                      spreadY: 1.5,
                    });
                  null != s && e.push(s);
            ...
            updateDroplets: function (t) {
              ...
              this.textureCleaningIterations > 0 &&
                ((this.textureCleaningIterations -= 1 * t),
                (this.dropletsCtx.globalCompositeOperation = "destination-out"),
                (this.dropletsCtx.fillStyle = "rgba(0,0,0," + 0.05 * t + ")"),
                ...
                this.options.raining &&
                  ((this.dropletsCounter +=
                    this.options.dropletsRate * t * this.areaMultiplier),
                  (0, l["default"])(this.dropletsCounter, function (t) {
                    e.dropletsCounter--,
                      e.drawDroplet(
                        (0, h.random)(e.width / e.scale),
                        (0, h.random)(e.height / e.scale),
                        h.random.apply(
                          void 0,
                          n(e.options.dropletsSize).concat([
                            function (t) {
                              return t * t;
                            },
                          ])
                ...
                this.drops.forEach(function (e, r) {
                  ...
                  if (!e.killed) {
                    if (
                      ((0, h.chance)(
                        (e.r -
                          this.options.minR * this.options.dropFallMultiplier) *
                          (0.1 / this.deltaR) *
                          t
                      ) &&
                        (e.momentum += (0, h.random)(
                          (e.r / this.options.maxR) * 4
                        )),
                      this.options.autoShrink &&
                        e.r <= this.options.minR &&
                        (0, h.chance)(0.05 * t) &&
                        (e.shrink += 0.01),
                      (e.r -= e.shrink * t),
                      e.r <= 0 && (e.killed = !0),
                      this.options.raining &&
                        ((e.lastSpawn +=
                          e.momentum * t * this.options.trailRate),
                        e.lastSpawn > e.nextSpawn))
                    ) {
                      var o = this.createDrop({
                        x: e.x + 0.1 * (0, h.random)(-e.r, e.r),
                        y: e.y - 0.01 * e.r,
                        r:
                          e.r *
                          h.random.apply(
                            void 0,
                            n(this.options.trailScaleRange)
                          ),
                        spreadY: 0.1 * e.momentum,
                        parent: e,
                      });
                      null != o &&
                        (i.push(o),
                        ...
                        (e.lastSpawn = 0),
                        (e.nextSpawn =
                          (0, h.random)(this.options.minR, this.options.maxR) -
                          2 * e.momentum * this.options.trailRate +
                          (this.options.maxR - e.r)));
                    }
                    (e.spreadX *= Math.pow(0.4, t)),
                      (e.spreadY *= Math.pow(0.7, t));
                    var a = e.momentum > 0;
                    a &&
                      !e.killed &&
                      ((e.y += e.momentum * this.options.globalTimeScale),
                      (e.x += e.momentumX * this.options.globalTimeScale),
                      e.y > this.height / this.scale + e.r && (e.killed = !0));
                    var l = (a || e.isNew) && !e.killed;
                    (e.isNew = !1),
                      l &&
                        this.drops.slice(r + 1, r + 70).forEach(function (i) {
                          if (
                            e != i &&
                            e.r > i.r &&
                            e.parent != i &&
                            ...
                            if (
                              o <
                              (e.r + i.r) *
                                (s.options.collisionRadius +
                                  e.momentum *
                                    s.options.collisionRadiusIncrease *
                                    t)
                            ) {
                              var a = Math.PI,
                                l = e.r,
                              ...
                              f > s.maxR && (f = s.maxR),
                                ...
                                (e.momentum = Math.max(
                                  ...
                                  Math.min(
                                    40,
                                    e.momentum +
                                      f * s.options.collisionBoostMultiplier +
                      ...
                      (e.momentum -=
                        0.1 *
                        Math.max(1, 0.5 * this.options.minR - e.momentum) *
                        t),
                      e.momentum < 0 && (e.momentum = 0),
                      (e.momentumX *= Math.pow(0.7, t)),
                      e.killed ||
                        (i.push(e),
                        a &&
                          this.options.dropletsRate > 0 &&
                          this.clearDroplets(
                            e.x,
                            e.y,
                            e.r * this.options.dropletsCleaningRadiusMultiplier
                          ),
                        this.drawDrop(this.ctx, e));
                  }
                }, this),
                (this.drops = i);
            },
            update: function () {
              ...
              var e = t - this.lastRender,
                i = e / ((1 / 60) * 1e3);
              i > 1.1 && (i = 1.1),
                (i *= this.options.globalTimeScale),
                (this.lastRender = t),
                this.updateDrops(i),
      ...
      function (t, e, i) {
        ...
        function r(t) {
          ...
          return (
            ...
            null == r && document.body.classList.add("no-webgl"),
            r
          );
        }
        function n(t, e, i) {
          ...
          if (!a) {
            ...
            return (
              h("Error in program linking: " + l), t.deleteProgram(o), null
            );
          }
        ...
        function a(t, e, i, r) {
          for (
            var n = t.getUniformLocation(e, "u_" + r),
              s = arguments.length,
              o = Array(s > 4 ? s - 4 : 0),
              a = 4;
            a < s;
        ...
        function c(t, e, i, r, n) {
          ...
          t.bufferData(
            t.ARRAY_BUFFER,
            new Float32Array([s, a, o, a, s, l, s, l, o, a, o, l]),
            t.STATIC_DRAW
          );
        }
        function h(t) {
